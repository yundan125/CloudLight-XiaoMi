...
{
    private readonly MainViewModel _main; private readonly PresenceDataTransferService _transfer; private readonly StartupRegistrationService _startup; private readonly AppPaths _paths; private bool _loaded;
    public SettingsWindow(MainViewModel main, PresenceDataTransferService transfer, StartupRegistrationService startup, AppPaths paths)
    {
        InitializeComponent(); DataContext = main; _main = main; _transfer = transfer; _startup = startup; _paths = paths; DataPathText.Text = paths.RootDirectory;
