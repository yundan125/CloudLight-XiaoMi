...
installer or uninstaller. The 2.1.0 installer contains a private Python 3.14 runtime and
...
dotnet publish .\src\CloudLight.Presence.App\CloudLight.Presence.App.csproj `
  ...
  -o .\artifacts\win-x64-2.1.0

.\installer\Prepare-MigateRuntime.ps1 `
  -PublishDirectory .\artifacts\win-x64-2.1.0
...
`artifacts\CloudLight-XiaoMi-Setup-2.1.0.exe`.
